// ╔══════════════════════════════════════════════════════
// ║  إعدادات شواهد - عدّل هذي القيم حسب الحاجة
// ╚══════════════════════════════════════════════════════

window.SHAWAHID_CONFIG = {
  // رابط منتجك على متجر زد - ← غيّر هذا!
  STORE_URL: 'https://shawahid.zid.store',
  
  // رقم الواتساب
  WHATSAPP_NUMBER: '966595552292',
